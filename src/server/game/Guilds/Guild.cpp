...
bool Guild::Member::LoadFromDB(Field* fields) {
	...
	SetStats(fields[20].GetString(), fields[21].GetUInt8(), fields[22].GetUInt8(), fields[23].GetUInt16(), fields[24].GetUInt32());
	m_logoutTime = fields[25].GetUInt32();
	
    SetProfession(0, fields[26].GetUInt32(), fields[27].GetUInt32(), fields[28].GetUInt32()); 
    SetProfession(1, fields[29].GetUInt32(), fields[30].GetUInt32(), fields[31].GetUInt32()); 
...
void Guild::_CreateDefaultGuildRanks(LocaleConstant loc) {
	...
	_CreateRank(sObjectMgr->GetFrenchCOREString(LANG_GUILD_MASTER, loc), GR_RIGHT_ALL);
	_CreateRank(sObjectMgr->GetFrenchCOREString(LANG_GUILD_OFFICER, loc), GR_RIGHT_ALL);
	_CreateRank(sObjectMgr->GetFrenchCOREString(LANG_GUILD_VETERAN, loc), GR_RIGHT_GCHATLISTEN |GR_RIGHT_GCHATSPEAK);
	_CreateRank(sObjectMgr->GetFrenchCOREString(LANG_GUILD_MEMBER, loc), GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
	_CreateRank(sObjectMgr->GetFrenchCOREString(LANG_GUILD_INITIATE, loc), GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
}
