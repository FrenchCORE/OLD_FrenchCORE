...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(sConfig->GetStringDefault("Motd", "Welcome to a FrenchCORE server."));
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outString();
    sLog->outString("Loading FRENCHCORE strings...");
    if (!sObjectMgr->LoadFrenchCOREStrings())
...
namespace Trinity
{
    class WorldWorldTextBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetFrenchCOREString(i_textId, loc_idx);
