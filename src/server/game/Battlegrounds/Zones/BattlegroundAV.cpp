...
void BattlegroundAV::HandleKillUnit(Creature *unit, Player *killer) {
	...
	if (entry == BG_AV_CreatureInfo[AV_NPC_A_BOSS][0]) {
		...
		if (creature)
			YellToAll(creature, GetFrenchCOREString(LANG_BG_AV_A_CAPTAIN_DEAD),
					LANG_UNIVERSAL);
		...
		Creature* creature = GetBGCreature(AV_CPLACE_HERALD);
		if (creature)
			YellToAll(creature, GetFrenchCOREString(LANG_BG_AV_H_CAPTAIN_DEAD),
					LANG_UNIVERSAL);
...
void BattlegroundAV::EventPlayerDestroyedPoint(BG_AV_Nodes node) {
	...
	if (IsTower(node))
		sprintf(
				buf,
				GetFrenchCOREString(LANG_BG_AV_TOWER_TAKEN),
				GetNodeName(node),
				(owner == ALLIANCE) ?
						GetFrenchCOREString(LANG_BG_AV_ALLY) :
						GetFrenchCOREString(LANG_BG_AV_HORDE));
	else
		sprintf(
				buf,
				GetFrenchCOREString(LANG_BG_AV_GRAVE_TAKEN),
				GetNodeName(node),
				(owner == ALLIANCE) ?
						GetFrenchCOREString(LANG_BG_AV_ALLY) :
						GetFrenchCOREString(LANG_BG_AV_HORDE));
...
//    }
	if (team == ALLIANCE || team == HORDE) {
		...
		sprintf(
				buf,
				GetFrenchCOREString(LANG_BG_AV_MINE_TAKEN),
				GetFrenchCOREString(
						(mine == AV_NORTH_MINE) ?
...
void BattlegroundAV::EventPlayerAssaultsPoint(Player* player, uint32 object) {
	...
	sprintf(
			buf,
			(IsTower(node)) ?
					GetFrenchCOREString(LANG_BG_AV_TOWER_ASSAULTED) :
					GetFrenchCOREString(LANG_BG_AV_GRAVE_ASSAULTED),
			GetNodeName(node),
			(team == ALLIANCE) ?
					GetFrenchCOREString(LANG_BG_AV_ALLY) :
					GetFrenchCOREString(LANG_BG_AV_HORDE));
...
const char* BattlegroundAV::GetNodeName(BG_AV_Nodes node) {
	...
	case BG_AV_NODES_FIRSTAID_STATION:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_STORM_AID);
	case BG_AV_NODES_DUNBALDAR_SOUTH:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_DUN_S);
	case BG_AV_NODES_DUNBALDAR_NORTH:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_DUN_N);
	case BG_AV_NODES_STORMPIKE_GRAVE:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_STORMPIKE);
	case BG_AV_NODES_ICEWING_BUNKER:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_ICEWING);
	case BG_AV_NODES_STONEHEART_GRAVE:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_STONE);
	case BG_AV_NODES_STONEHEART_BUNKER:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_STONE);
	case BG_AV_NODES_SNOWFALL_GRAVE:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_SNOW);
	case BG_AV_NODES_ICEBLOOD_TOWER:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_ICE);
	case BG_AV_NODES_ICEBLOOD_GRAVE:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_ICE);
	case BG_AV_NODES_TOWER_POINT:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_POINT);
	case BG_AV_NODES_FROSTWOLF_GRAVE:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_FROST);
	case BG_AV_NODES_FROSTWOLF_ETOWER:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_FROST_E);
	case BG_AV_NODES_FROSTWOLF_WTOWER:
		return GetFrenchCOREString(LANG_BG_AV_NODE_TOWER_FROST_W);
	case BG_AV_NODES_FROSTWOLF_HUT:
		return GetFrenchCOREString(LANG_BG_AV_NODE_GRAVE_FROST_HUT);
	default:
