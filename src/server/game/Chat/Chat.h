...
#ifndef FRENCHCORE_CHAT_H
#define FRENCHCORE_CHAT_H
...
class ChatHandler
{
    public:
        ...
        virtual const char *GetFrenchCOREString(int32 entry) const;
...
class CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
        const char *GetFrenchCOREString(int32 entry) const;
