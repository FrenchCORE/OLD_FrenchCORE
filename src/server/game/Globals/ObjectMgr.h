...
// FRENCHCORE string ranges
#define MIN_frenchcore_string_ID           1                    // 'frenchcore_string'
#define MAX_frenchcore_string_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_frenchcore_string_ID // 'db_script_string'
#define MAX_DB_SCRIPT_STRING_ID        2000010000
#define MIN_CREATURE_AI_TEXT_STRING_ID (-1)                 // 'creature_ai_texts'
#define MAX_CREATURE_AI_TEXT_STRING_ID (-1000000)

// Trinity Trainer Reference start range
#define FRENCHCORE_TRAINER_START_REF      200000

struct FrenchCoreStringLocale {
...
typedef UNORDERED_MAP<int32, FrenchCoreStringLocale> FrenchCoreStringLocaleMap;
...
public:
	...
	bool LoadFrenchCOREStrings(char const* table, int32 min_value, int32 max_value);
	bool LoadFrenchCOREStrings() {return LoadFrenchCOREStrings("frenchcore_string", MIN_frenchcore_string_ID, MAX_frenchcore_string_ID);}
	...
	FrenchCoreStringLocale const* GetFrenchCOREStringLocale(int32 entry) const
	{
		FrenchCoreStringLocaleMap::const_iterator itr = mFrenchCoreStringLocaleMap.find(entry);
		if (itr == mFrenchCoreStringLocaleMap.end()) return NULL;
		return &itr->second;
	}
	const char *GetFrenchCOREString(int32 entry, LocaleConstant locale_idx) const;
	const char *GetFrenchCOREStringForDBCLocale(int32 entry) const {return GetFrenchCOREString(entry, DBCLocaleIndex);}
...
private:
	...
	FrenchCoreStringLocaleMap mFrenchCoreStringLocaleMap;
...
bool LoadFrenchCOREStrings(char const* table, int32 start_value =
