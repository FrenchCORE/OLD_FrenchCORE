...
void CreatureEventAIMgr::LoadCreatureEventAI_Texts()
{
	...
	// Load EventAI Text
	sObjectMgr->LoadFrenchCOREStrings("creature_ai_texts", MIN_CREATURE_AI_TEXT_STRING_ID, MAX_CREATURE_AI_TEXT_STRING_ID);
	...
	do
	{
		...
		if (!sObjectMgr->GetFrenchCOREStringLocale(i))
		{
