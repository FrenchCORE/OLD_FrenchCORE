...
#ifndef FRENCHCORE_CREATURE_EAI_H
#define FRENCHCORE_CREATURE_EAI_H
...
enum EventAI_Type
{
	...
	EVENT_T_RESET = 35,					// Is it called after combat, when the creature respawn and spawn. -- FrenchCORE ONLY
