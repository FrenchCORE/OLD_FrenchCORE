...
#ifndef __FRENCHCORE_LANGUAGE_H
#define __FRENCHCORE_LANGUAGE_H

enum FrenchCOREStrings {
	// for chat commands
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
	...
	// Room for more FRENCHCORE Strings      5030-9999
