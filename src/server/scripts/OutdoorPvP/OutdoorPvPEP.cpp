...
void OPvPCapturePointEP_EWT::ChangeState() {
	...
	if (m_OldState == OBJECTIVESTATE_ALLIANCE && m_OldState != m_State) {
		sWorld->SendZoneText(
				EP_GraveYardZone,
				sObjectMgr->GetFrenchCOREStringForDBCLocale(
...
void OPvPCapturePointEP_PWT::SummonFlightMaster(uint32 team) {
	if (m_FlightMasterSpawned != team) {
		...
		/*
		 ...
		 gso.GossipId = 0;
		 gso.OptionText.assign(sObjectMgr->GetFrenchCOREStringForDBCLocale(LANG_OPVP_EP_FLIGHT_NPT));
		 gso.Id = 50;
		 gso.Icon = 0;
		 gso.NpcFlag = 0;
		 gso.BoxMoney = 0;
		 ...
		 gso.Action = GOSSIP_OPTION_OUTDOORPVP;
		 gso.GossipId = 0;
		 gso.OptionText.assign(sObjectMgr->GetFrenchCOREStringForDBCLocale(LANG_OPVP_EP_FLIGHT_EWT));
		 gso.Id = 50;
		 gso.Icon = 0;
		 gso.NpcFlag = 0;
		 gso.BoxMoney = 0;
		 ...
		 gso.Action = GOSSIP_OPTION_OUTDOORPVP;
		 gso.GossipId = 0;
		 gso.OptionText.assign(sObjectMgr->GetFrenchCOREStringForDBCLocale(LANG_OPVP_EP_FLIGHT_CGT));
		 gso.Id = 50;
		 gso.Icon = 0;
		 gso.NpcFlag = 0;
		 gso.BoxMoney = 0;
