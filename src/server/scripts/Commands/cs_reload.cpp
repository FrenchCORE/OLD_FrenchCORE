...
public:
		...
		static ChatCommand reloadCommandTable[] =
				{
						...
						{ "spell_scripts", SEC_ADMINISTRATOR, true,
								...
								"", NULL }, { "frenchcore_string",
								SEC_ADMINISTRATOR, true,
								&HandleReloadArkCoreStringCommand, "", NULL }, {
	...
	static bool HandleReloadArkCoreStringCommand(ChatHandler* handler,
			const char* /*args*/) {
		sLog->outString("Re-Loading frenchcore_string Table!");
		sObjectMgr->LoadFrenchCOREStrings();
		handler->SendGlobalGMSysMessage("DB table `frenchcore_string` reloaded.");
		return true;
	}
