...
#ifndef _FRENCHCORE_REALM_CONFIG
# define _FRENCHCORE_REALM_CONFIG  "authserver.conf"
#endif //_FRENCHCORE_REALM_CONFIG
#ifdef _WIN32
#include "ServiceWin32.h"
char serviceName[] = "authserver";
char serviceLongName[] = "FrenchCORE Auth service";
char serviceDescription[] = "FrenchCORE World of Warcraft emulator world auth service";
/*
...
extern int main(int argc, char **argv) {
	...
	///- Command line parsing to get the configuration file name
			char const* cfg_file = _FRENCHCORE_REALM_CONFIG;
			int c = 1;
			while(c < argc)
			{
		...
		sLog->outString(" ");
			sLog->outString(" World Of Warcraft : Emulateur Cataclysm");
/*			sLog->outString("       _/_/              _/          _/_/_/    _/_/    _/_/_/    _/_/_/_/  ");
			...
			sLog->outString(" FrenchCORE (c) 2012 <http://www.frcore.net/>");
		sLog->outString(" ");
		...
		sLog->outDetail("%s (Library: %s)", OPENSSL_VERSION_TEXT, SSLeay_version(SSLEAY_VERSION));
			...
			{
				sLog->outError("FrenchCORE Auth can not bind to %s:%d", bind_ip.c_str(), rmport);
				return 1;
			}
...
#ifdef _WIN32
	{
		...
		if (Prio)
		{
			...
			sLog->outString("FrenchCORE Auth process priority class set to HIGH");
			else
